...
class Extract(nn.Module):
    def __init__(self):
        ...
        model = torch.load('/home/daip/share/old_share/wxf/Tea_cake_CBIR/weights/mobilenet/MobileNetV2_bird_2022_7_18.pth')
...
np.savez('/home/daip/share/old_share/wxf/Tea_cake_CBIR/npz/bird_test_mobile.npz', vector=dog_test_data, utt=dog_lable)