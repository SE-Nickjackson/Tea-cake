...
from model.MobileNet.pre_model import model
...
#优化器 这里用Adam
optimizer = optim.RMSprop(net.parameters(), lr=0.0001,momentum=0.9,weight_decay=0.00004)
scheduler = StepLR(optimizer, step_size=500, gamma=0.98)
#训练参数保存路径

save_path = '/home/daip/share/old_share/wxf/Tea_cake_CBIR/weights/mobilenet/MobileNetV2_bird_2022_7_18.pth'
#训练过程中最高准确率
best_acc = 0.0
#开始进行训练和测试，训练一轮，测试一轮
