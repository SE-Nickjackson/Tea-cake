...
loss_func = losses.SubCenterArcFaceLoss(num_classes=4, embedding_size=2048).to(device)
loss_optimizer = torch.optim.Adam(loss_func.parameters(), lr=1e-4)
accuracy_calculator = AccuracyCalculator(include=("precision_at_1",), k=1)
### pytorch-metric-learning stuff ###
for epoch in range(1, num_epochs + 1):
    train(model, loss_func, device, test_data, optimizer, loss_optimizer, epoch)

torch.save(model,'/home/daip/share/old_share/wxf/Tea_cake_CBIR/weights/subarc/ResNet50_tea-cake_subarcloss_2022_7_18.pth')
